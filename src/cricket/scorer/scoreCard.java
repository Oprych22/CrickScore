...
public class scoreCard extends Fragment implements OnClickListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
    	...
    	ll = (LinearLayout) inflater.inflate(R.layout.scorecard, container, false);
        ...
        //screenSetup();
        TextView battingName = (TextView) ll.findViewById(R.id.teamBatting_Scorecard1);
        battingName.setText(game.getMatch().getTeam(1).getName());
        //screenSetup();
        created = 1;
...
//	}
    ...
    {
    	TableLayout table = (TableLayout) ll.findViewById(R.id.ScoreCard1_Table);
    	
    	table.removeAllViews();
    	/*************************************************************************/
        /*			Batting creation                                             */
        /*************************************************************************/
    	TableRow battingNameRow = new TableRow(fa);
    	TextView battingNameView = new TextView(fa);
    	
    	battingNameView.setText(game.getMatch().getTeam(1).getName());
    	battingNameView.setTextColor(Color.WHITE);
    	battingNameView.setWidth(100);
    	battingNameView.setTextSize(40);
    	
    	
    	battingNameRow.addView(battingNameView);
         
         // add the TableRow to the TableLayout
         table.addView(battingNameRow,new TableLayout.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
    	...
    	{
    		Player currentPlayer = game.getMatch().getTeam(1).getPlayerByPos(i+1);
            ...
            {
	            if (currentPlayer.getName().equals(game.getMatch().getTeam(1).getFacing().getName()))
	            {
            ...
            balls.setText(String.valueOf(currentPlayer.getNumberOfDeliveries()));
        ...
        allRuns.setText(String.valueOf(game.getMatch().getTeam(1).getTeamRuns()));
    	...
    	{
        	Player bowler = game.getMatch().getTeam(2).getPlayerByPos(i+1);
        	int hasHeBowled = 0;
        	int runsBowler = 0;
        	...
        	if (game.getMatch().getNextBowler().getName().equals(game.getMatch().getTeam(2).getPlayerByPos(i+1).getName()))
        	{
            	...
            	wicketsBowler += game.match.getActiveOver().getOverWicketsForBowler();
